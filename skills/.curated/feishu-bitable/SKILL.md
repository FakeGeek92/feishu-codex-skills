---
name: feishu-bitable
description: Use when creating or managing Feishu Bitable apps, tables, fields, views, and records from Codex.
---
...
- `feishu_bitable_app` -> `node scripts/bitable.js app '<json>'`
- `feishu_bitable_app_table` -> `node scripts/bitable.js table '<json>'`
- `feishu_bitable_app_table_field` -> `node scripts/bitable.js field '<json>'`
- `feishu_bitable_app_table_record` -> `node scripts/bitable.js record '<json>'`
- `feishu_bitable_app_table_view` -> `node scripts/bitable.js view '<json>'`
