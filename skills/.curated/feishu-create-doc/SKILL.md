...
description: Use when creating a Feishu cloud document from Lark-flavored Markdown in Codex.
---
...
- 执行命令：`node scripts/create-doc.js '<json>'`
- 这个脚本内部仍然调用 Feishu 官方 MCP `create-doc`
