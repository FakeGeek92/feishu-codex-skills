---
name: feishu-im-read
description: Use when reading Feishu chat history, thread replies, search results, or downloading message resources in Codex.
---
...
- `feishu_im_user_get_messages` -> `node scripts/im-read.js messages '<json>'`
- `feishu_im_user_get_thread_messages` -> `node scripts/im-read.js thread '<json>'`
- `feishu_im_user_search_messages` -> `node scripts/im-read.js search '<json>'`
- `feishu_im_user_fetch_resource` -> `node scripts/im-read.js resource '<json>'`
